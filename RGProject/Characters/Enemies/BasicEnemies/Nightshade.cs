...
public class Nightshade(string name) : ICharacter
{
    ...
    public CharacterType Type { get; } = CharacterType.Nightshade;
    ...
    public double Health { get; set; } = 1700;
    public double MaxHealth { get; set; } = 1700;
    public double Damage { get; set; } = 150;
