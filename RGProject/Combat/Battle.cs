...
public class Battle : IBattle
{
    ...
    // ShieldBash = {70/*+def*/, 70/*+catk*/, 1 /*Rounds*/}; //Hero Warrior
    // WarCry = {20/*+def*/, 1 /*Rounds*/}; //Hero Warrior
    // HolyShield = {20/*+def*/, 1 /*Rounds*/}; //Hero Paladin
    // Crown = { 25/*+def*/, 1 /*Rounds*/}; //Hero Hero
    // GettingACape1 = { 20/*+dmg*/, 10/*+def*/, 2 /*Rounds*/}; //Hero Hero
    // SmokeBomb = {20/*-dmg*/,1 /*Rounds*/}; //Hero Ninja
    // SharperDagger = { 15/*-dmg*/, 1 /*Rounds*/}; //Enemy Ninja
    // PosionDaggers = { 50/*deal dmg*/, 50/*-dmg*/, 1 /*Rounds*/}; //Enemy Assassin
    // IceShard = {50/*-dmg*/, 1 /*Rounds*/}; //Enemy Mage
    // ArrowRain = {15/*-stun*/, 15/*-combo*/, 1 /*Rounds*/}; //Enemy Elf
    // HolyLight = {10/*-def*/, 25/*-catk*/, 1 /*Rounds*/}; //Enemy Paladin
